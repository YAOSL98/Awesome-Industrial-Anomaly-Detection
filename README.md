...
| [**MUSC: ZERO-SHOT INDUSTRIAL ANOMALY CLASSIFICATION AND SEGMENTATION WITH MUTUAL SCORING OF THE UNLABELED IMAGES**](https://openreview.net/forum?id=AHgc5SMdtd) |  ICLR  |  [https://github.com/openvinotoolkit/anomalib]  |   [VisA](https://github.com/amazon-science/spot-diff)  | unsupervised![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/CVPR2024/cvpr1.1.png)  | **1. Evaluation metrics and accuracy:** VisA数据集上使用不同的方法AUROC和AUPRO效果都高![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/CVPR2024/cvpr1.2.png)<br> **2. Computational cost:** 训练时间无，测试时间无         |
|         |          |          |          |          |          |
|         |          |          |          |          |          |
|         |          |          |          |          |          |
