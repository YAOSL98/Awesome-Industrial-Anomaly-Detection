...
| [**ANOMALYCLIP: OBJECT-AGNOSTIC PROMPT LEARNING FOR ZERO-SHOT ANOMALY DETECTION**](https://openreview.net/forum?id=buC4E91xZE) |  ICLR  |  [github](https://github.com/zqhang/AnomalyCLIP)  |   [VisA](https://github.com/amazon-science/spot-diff) [MVTec AD](https://www.mvtec.com/company/research/datasets/mvtec-ad) [MPDD] [BTAD] [SDD] [DAGM] [DTD-Synthetic]| unsupervised![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/ICLR2024/ICLR2.1.png)  | **1. Evaluation metrics and accuracy:** 在多个数据集上，本文方法对比其他方法在AUROC AUPRO都有一定的提升 ![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/ICLR2024/ICLR2.2.png)<br> **2. Computational cost:** 训练时间无，测试时间无         |
|         |          |          |          |          |          |
|         |          |          |          |          |          |
|         |          |          |          |          |          |
