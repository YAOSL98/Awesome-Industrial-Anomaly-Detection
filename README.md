...
| [**ANOMALYCLIP: OBJECT-AGNOSTIC PROMPT LEARNING FOR ZERO-SHOT ANOMALY DETECTION**](https://openreview.net/forum?id=buC4E91xZE) |  ICLR  |  [github](https://github.com/zqhang/AnomalyCLIP)  |   [VisA](https://github.com/amazon-science/spot-diff) [MVTec AD](https://www.mvtec.com/company/research/datasets/mvtec-ad) [MPDD] [BTAD] [SDD] [DAGM] [DTD-Synthetic]| Semi-supervised![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/ICLR2024/ICLR2.1.png)  | **1. Evaluation metrics and accuracy:** 在多个数据集上，本文方法对比其他方法在AUROC AUPRO都有一定的提升 ![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/ICLR2024/ICLR2.2.png)<br> **2. Computational cost:** 训练时间无，测试时间无         |
| [**Generating and Reweighting Dense Contrastive Patterns for Unsupervised Anomaly Detection**](https://ojs.aaai.org/index.php/AAAI/article/view/27910) |  AAAI  |  -  |   [MVTec AD](https://www.mvtec.com/company/research/datasets/mvtec-ad) [MVTec LOCO]| Unsupervised![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/AAAI2024/AAAI1.1.png)  | **1. Evaluation metrics and accuracy:** 在MVTec AD和MVTec LOCO数据集上，本文方法对比其他方法在AUROC都有一定的提升 ![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/AAAI2024/AAAI1.2.png)<br> **2. Computational cost:** 训练时间无，测试时间无         |
| [**AnomalyGPT: Detecting Industrial Anomalies Using Large Vision-Language Models**](https://ojs.aaai.org/index.php/AAAI/article/view/27963) |  AAAI  |  [github](https://github.com/CASIA-IVA-Lab/AnomalyGPT)  |    [VisA](https://github.com/amazon-science/spot-diff) [MVTec AD](https://www.mvtec.com/company/research/datasets/mvtec-ad) | Unsupervised![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/AAAI2024/AAAI2.1.png)  | **1. Evaluation metrics and accuracy:** 在MVTec AD和VisA数据集上，本文方法对比其他方法在image-level和pixel-level的AUC都有一定的提升 ![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/AAAI2024/AAAI2.2.png)<br> **2. Computational cost:** 训练时间无，测试时间无         |
| [**Contextual Affinity Distillation for Image Anomaly Detection**](https://openaccess.thecvf.com/content/WACV2024/papers/Zhang_Contextual_Affinity_Distillation_for_Image_Anomaly_Detection_WACV_2024_paper.pdf) |  wacv  |  -  |   [MVTec AD](https://www.mvtec.com/company/research/datasets/mvtec-ad) [MVTec LOCO]| Unsupervised![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/wacv2024/wacv1.1.png)  | **1. Evaluation metrics and accuracy:** 在MVTec AD和MVTec LOCO数据集上，本文方法对比其他方法在AUROC的效果较好 ![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/wacv2024/wacv1.2.png)<br> **2. Computational cost:** 训练时间无，测试时间无         |
|         |          |          |          |          |          |
|         |          |          |          |          |          |
|         |          |          |          |          |          |
