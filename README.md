...
| [**Divide and Conquer: High-Resolution Industrial Anomaly Detection via  Memory Efficient Tiled Ensemble**](https://arxiv.org/abs/2403.04932) |  CVPR  |  [https://github.com/openvinotoolkit/anomalib]  |   [VisA](https://github.com/amazon-science/spot-diff)  | full-supervised![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/ICASSP2024-1-1.png)  | **1. Evaluation metrics and accuracy:** VisA数据集上使用不同的方法AUROC和AUPRO效果都高![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/ICASSP2024-1-2.png)<br> **2. Computational cost:** 训练时间无，测试时间无         |
|         |          |          |          |          |          |
|         |          |          |          |          |          |
|         |          |          |          |          |          |
